...
public class BinaryTreeWithParentLinkTest {
  ...
  public void testToUINull() {
    Assert.assertEquals("", ((BinaryTreeWithParentLink) objectUnderTest).toUI());
  }
  ...
  public void testToUINoChildren() {
    ...
    Assert.assertEquals("1", ((BinaryTreeWithParentLink) objectUnderTest).toUI());
  }
  ...
  public void testToUIBothChildren() {
    ...
    Assert.assertEquals("1┬0\n └2", ((BinaryTreeWithParentLink) objectUnderTest).toUI());
  }
  ...
  public void testToUIMultipleLevels() {
    ...
    Assert.assertEquals("1┬2┬4\n │ └5\n └3┬6\n   └7", ((BinaryTreeWithParentLink) objectUnderTest).toUI());
  }
  ...
  public void testToUIMultipleLevelsNonFull() {
    ...
    Assert.assertEquals("1┬2┬4\n │ └5\n └3", ((BinaryTreeWithParentLink) objectUnderTest).toUI());
  }
}
