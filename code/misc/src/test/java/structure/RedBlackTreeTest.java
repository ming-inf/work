...
public class RedBlackTreeTest {
  private RedBlackTree<Integer> objectUnderTest;

  @Before
  public void setup() {
    objectUnderTest = new RedBlackTree<>();
  }
  ...
  public void testInsertCase4() {
    objectUnderTest.add(15);
    objectUnderTest.add(20);
    objectUnderTest.add(0);
    objectUnderTest.add(3);
    objectUnderTest.add(13);
    objectUnderTest.add(14);
  }
